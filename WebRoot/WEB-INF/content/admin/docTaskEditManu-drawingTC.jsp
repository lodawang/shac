...
<div class="main">
  ...
  <div class="right">
    ...
    <form action="saveDrawDocuTC.do" method="post" enctype="multipart/form-data" onsubmit="return confirm('本操作是修改临时库，要入正式库，请在发放范围内，发放文件!？');">
    <s:hidden name="docutc.id"></s:hidden>
    <s:hidden name="docutc.docType" value="0"></s:hidden>
    ...
    <s:hidden name="initdoctype" value="0" ></s:hidden>
    <table width="99%" border="0" cellpadding="0" cellspacing="0" class="table_form">
      ...
      <tr>
        <th>文档ID：</th>
        <td>
        <s:textfield name="docutc.partid" cssClass="u23"/>
        </td>
        <th>图纸号：</th>
        <td><span class="main_container">
          <s:textfield name="docutc.drawingNumb" cssClass="u32"/>
        </span></td>
        <th>图纸张数：</th>
        <td><span class="main_container">
          <s:textfield name="docutc.drawingPage" cssClass="u34"/>
        </span></td>
      </tr>
      <tr >
        <th>图幅：</th>
        <td><span class="main_container">
          <s:select cssClass="u36" cssStyle="width:152px" list="drawingSizeList" name="docutc.drawingSize" listKey="dictValue" listValue="dictValue" headerKey="" headerValue="请选择"></s:select>
        </span></td>
        <th>客户：</th>
        <td><span class="main_container">
      ...
      <tr>
        ...
        <th>附件：</th>
        <td colspan="3"><s:file name="attach" />
      ...
      <tr>
        ...
        <td colspan="2"><input name="button" type="submit" class="btn_gray" id="button" value="保 存" />
          　
        </td>
      </tr>
    </table>
