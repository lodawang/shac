  ...
  <div class="right">
    ...
    <div class="btn_frame">
      ...
      <div style="float:right">
        <input name="button3" type="submit" class="btn_ty" id="button3" value="发放范围"     onclick="window.location='viewTask.do?id=<s:property value="docu.id"/>'" />
        <s:if test='docu.taskStatus=="1"'>
        <input name="button4" type="submit" class="btn_ty" id="button4" value="版本升级"    onclick="window.location='editVersionDocu.do?id=<s:property value="docu.id"/>'" />
        </s:if>
      </div>
      </s:if>
    </div>
    ...
    <form action="saveTechDocu.do" method="post" enctype="multipart/form-data" onsubmit="return confirm('本操作是修改当前版本属性，版本升级请先点击右上方升级按钮，确认保存？');">
    <s:hidden name="docu.id"></s:hidden>
    <s:hidden name="docu.docType" value="1"></s:hidden>
