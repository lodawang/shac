...
<div class="main">
  ...
  <div class="right">
    ...
    <div class="btn_frame">
      <div style="float:left"><h1>工艺文档查询</h1></div>
    </div>
    <form name="searchForm" action="complexProcDocList.do" method="post" onsubmit="schFormOnSubmit();">
...
<tr>
        ...
        <tr <s:if test="#stat.even==true">class="td_bg1"</s:if>>
          ...
          <td align="center">
          	<a href="<s:url action="showProcessDocument" namespace="/admin"><s:param name="id" value="id"/></s:url>" class="font_green"><strong><u>查看</u></strong></a>
          </td>
        </tr>
        </s:iterator>
      </table>
      <p class="page-inner" style="text-align:right;width:99%">
		<pg:pager items="${totalCount}" url="${pageContext.request.contextPath}/admin/complexProcDocList.do" index="center" maxPageItems="500" maxIndexPages="500" isOffset="<%=false%>" export="currentPageNumber=pageNumber" scope="request">
		<pg:index export="pageCount">
			...
			转到  <select onchange="selectedPage=this.value;jumpPage('<s:url value="/admin/complexProcDocList.do"/>',selectedPage)">
