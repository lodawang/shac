...
<div class="main">
  ...
  <div class="right">
    ...
    <form action="docTechQueryList.do" method="post" name="searchForm" onsubmit="schFormOnSubmit();">
...
技术资料</td>
      ...
      <tr>
        ...
        <td colspan="3"><span class="main_container">
          <s:textfield name="docu.assembTitle" cssClass="u34" theme="simple"/>
        </span><input name="button" type="submit" class="btn_gray" id="button" value="查询" /></td>
      </tr>
    </table>
    </form>
...
<tr>
 	  ...
 	  <p class="page-inner" style="text-align:right;width:99%">
		<pg:pager items="${totalCount}" url="${pageContext.request.contextPath}/admin/docTechQueryList.do" index="center" maxPageItems="500" maxIndexPages="500" isOffset="<%=false%>" export="currentPageNumber=pageNumber" scope="request">
		<pg:index export="pageCount">
			...
			转到  <select onchange="selectedPage=this.value;jumpPage('<s:url value="/admin/docTechQueryList.do"/>',selectedPage)">
