...
<div class="main">
  ...
  <div class="right">
    ...
    <div class="btn_frame">
     ...
     <form action="saveadvicedealtwo.do" method="post" enctype="multipart/form-data">
        <s:hidden name="id"></s:hidden>
        <s:hidden name="advice.task.id"></s:hidden>
        <table width="99%" border="0" cellpadding="0" cellspacing="0" class="table_form">
          ...
          <tr>
	        <th>类型：</th>
	        <td><s:if test="advice.task.docType==0">
          产品图纸
          </s:if>
          <s:if test="advice.task.docType==1">
         技术文件
          </s:if>
          <s:if test="advice.task.docType==2">
         工艺文档
          </s:if></td>
	        <th>零件号:</td>
	        <td><s:property value="advice.task.cltPartNumb"/></td>	        
          </tr>
           <tr>
	        <th>名称：</th>
	        <td><s:property value="advice.task.assembTitle"/></td>
	        <th>总成:</td>
	        <td><s:property value="advice.task.assembly"/> </td>	        
          </tr>
          ...
          <tr>
            <th>厂部意见：</th>
	        <td><s:textarea name="advice.baketwo" cols="40" rows="10" ></s:textarea></td>
	        <td>&nbsp;</td>
	        <td>&nbsp;</td>
          </tr>       
          <tr>
