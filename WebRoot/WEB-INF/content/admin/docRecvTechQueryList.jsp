...
<div class="main">
    ...
    <ul class="menu">
      ...
      <li class="menu_2" ><a href="docRecvQueryList.do" onmouseout="MM_swapImgRestore()" onmouseover="MM_swapImage('文档查询','','../img/btn_wdxc.png',1)"><img src="../img/btn_wdxc.png" alt="文档查询" name="文档查询" width="170" height="69" border="0" id="文档查询" /></a></li>
  ...
  <div class="right">
    ...
    <div class="btn_frame">
      ...
      <div style="float:right">
        <input name="button3" type="submit" class="btn_ty" id="button3" value="图纸查询"     onclick="window.location='docRecvQueryList.do'" />
        <input name="button4" type="submit" class="btn_ty" style="padding-left:12px"  value="技术文件查询"    onclick="window.location='docRecvTechQueryList.do'" />
        <input name="button4" type="submit" class="btn_ty" style="padding-left:12px"  value="工艺文档查询"    onclick="window.location='recvProcDocList.do'" />
      </div>
    </div>
    <form name="searchForm" action="docRecvTechQueryList.do" method="post">
...
技术资料</td>
        <th> 技术文档分类：</th>
        <td>
        <s:select cssClass="u36" cssStyle="width:152px" list="techDocClassList" name="docu.techDocClass" listKey="dictValue" listValue="dictValue" headerKey="" headerValue="请选择"></s:select>
        </td>
        <th>总成号：</th>
      ...
      <tr>
        <th>文档ID：</th>
        <td><s:textfield name="docu.partid" cssClass="u23"/></td>
        <th>版本：</th>
        <td><span class="main_container">
          <s:textfield name="docu.docVersion" cssClass="u32"/>
        </span></td>
        <th>零件号：</th>
        <td><span class="main_container">
...
<tr>
        ...
        <tr <s:if test="#stat.even==true">class="td_bg1"</s:if>>
          <td <s:if test='task.beta=="1"'>bgcolor="orange"</s:if>  title="试运行文件"> <s:property value="#stat.count"/> </td>
          ...
          <td> <s:property value="task.client"/> </td>
           <td> <s:property value="task.modelCode"/> </td>
         ...
         技术文件
          ...
          <td> <s:property value="task.techDocClass"/> </td>
          <td> 
          ...
          <td align="center">
          	<a href="<s:url action="docPreview" namespace="/admin"><s:param name="id" value="id"/></s:url>" class="font_green"><strong><u>查看</u></strong></a>
          </td>
        </tr>
        </s:iterator>
      </table>
       <p class="page-inner" style="text-align:right;width:99%">
		<pg:pager items="${totalCount}" url="${pageContext.request.contextPath}/admin/docRecvTechQueryList.do" index="center" maxPageItems="500" maxIndexPages="500" isOffset="<%=false%>" export="currentPageNumber=pageNumber" scope="request">
		<pg:index export="pageCount">
			...
			转到  <select onchange="selectedPage=this.value;jumpPage('<s:url value="/admin/docRecvTechQueryList.do"/>',selectedPage)">
