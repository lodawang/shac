  ...
  <div class="right">
    ...
    <div class="btn_frame">
      ...
      <div style="float:right">
        <input name="button3" type="submit" class="btn_ty"  value="图纸查询"     onclick="window.location='docRecvQueryList.do'" />
    ...
    <form name="searchForm" action="recvProcDocList.do" method="post">
...
<tr>
      ...
      <p class="page-inner" style="text-align:right;width:99%">
		<pg:pager items="${totalCount}" url="${pageContext.request.contextPath}/admin/recvProcDocList.do" index="center" maxPageItems="500" maxIndexPages="500" isOffset="<%=false%>" export="currentPageNumber=pageNumber" scope="request">
		<pg:index export="pageCount">
			...
			转到  <select onchange="selectedPage=this.value;jumpPage('<s:url value="/admin/recvProcDocList.do"/>',selectedPage)">
