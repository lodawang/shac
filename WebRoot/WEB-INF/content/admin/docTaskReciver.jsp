...
function undoIssue(dptId){
	if(confirm("确认操作？")){
		document.optForm.action = "<s:url value="/admin/undoIssue.do"/>";
  ...
  <div class="right">
    ...
    <table width="99%" border="0" cellpadding="0" cellspacing="0" class="table_form">
      <tr class="td_bg1">
        ...
        <th>图幅/页数：</th>
        <td><s:property value="task.drawingSize"/> / <s:property value="task.drawingPage"/>页</td>
        <th>版本号：</th>
      ...
      <tr class="td_bg1">
        ...
        <th>TC中版本号：</th>
        <td><s:property value="task.veroftc"/>&nbsp;</td>
        <th align="right">物理文件：</th>
        <td><a href="<s:url value="%{task.attachFile}"/>" class="font_green">附件</a>
        <s:if test="task.viewFile!=null">
        <a href="docProtectView.do?id=<s:property value="task.id"/>" target="_blank" class="font_green">受保护文件</a>
        </s:if>
        </td>
        <th>名称：</th>
    ...
    <table width="99%" border="0" cellpadding="0" cellspacing="0" class="table_form">
      <tr class="td_bg1">
        ...
        <th>版本号：</th>
        <td colspan="3"><s:property value="task.docVersion"/>&nbsp;</td>
      </tr>
      <tr >
        <th align="right">客户：</th>
        <td><s:property value="task.client"/></td>
        ...
        <td><s:property value="task.modelCode"/></td>
        <th>零件号：</th>
        <td colspan="3"><s:property value="task.cltPartNumb"/></td>
      </tr>
      <tr class="td_bg1">
      	<th>总成：</th>
        <td><s:property value="task.assembly"/></td>
        ...
        <td><s:property value="task.veroftc"/></td>
        <th align="right">物理文件：</th>
        <td><a href="<s:url value="%{task.attachFile}"/>" class="font_green">附件</a></td>
        <th>名称：</th>
        <td><s:property value="task.assembTitle"/></td>
      </tr>
    </table>
    ...
    <form name="optForm" action="<s:url value="/admin/issueDocu.do"/>" method="post">
