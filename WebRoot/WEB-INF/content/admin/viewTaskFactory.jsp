...
function undoIssue(dptId){
	if(confirm("确认撤销")){
		document.optForm.action = "<s:url value="/admin/factoryUndoDocIssuePic.do"/>";
...
function destroyIssue(dptId){
	if(confirm("确认已取消发放？")){
		document.optForm.action = "<s:url value="/admin/destroyProcDocAtLatestPic.do"/>";
		document.optForm.deptId.value = dptId;
		document.optForm.submit();
	}
}
...
<div class="main">
  ...
  <div class="right">
    <div class="text_c"> 当前位置：首页  &gt;图纸发放范围</div>
    <div class="btn_frame">
 ...
 <div class="btn_frame">
    ...
    <form name="optForm" action="<s:url value="/admin/factoryDocMngIssuePicSave.do"/>" method="post">
