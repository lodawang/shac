...
function jumpPage(url,toPage){
	gotoPage(url+"?pager.offset="+(toPage-1)*50,toPage);
}
</script>
</head>
...
<div class="main">
  ...
  <div class="right">
    ...
    <form name="searchForm" action="docReport.do" method="post"">
...
<tr>
 	 ...
 	 <p class="page-inner" style="text-align:right;width:99%">
		<pg:pager items="${totalCount}" url="${pageContext.request.contextPath}/admin/docReport.do" index="center" maxPageItems="15" maxIndexPages="15" isOffset="<%=false%>" export="currentPageNumber=pageNumber" scope="request">
		<pg:index export="pageCount">
			...
			转到  <select onchange="selectedPage=this.value;jumpPage('<s:url value="/admin/docReport.do"/>',selectedPage)">
