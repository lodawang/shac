...
<div class="main">
  ...
  <div class="right">
    <div class="text_c">
      当前位置：首页 &gt; 系统设置
    &gt;批量接收       | <a href="issueRuleList.do">发放规则 </a></div>
    <div class="btn_frame">
      <div style="float:left"><h1>批量接收      </h1></div>（根据输入的用户名，批量接收用户所属厂部的所有未签收文件）
    </div>
    ...
    <form action="batchConfirmReceive.do" method="post">
    <table width="99%" border="0" cellpadding="0" cellspacing="0" class="table_form">
      <tr>
        <th>用户登录ID：</th>
        <td><span class="main_container">
          <s:textfield name="uloginId" cssClass="u27"/>
        </span></td>            
      </tr>
      <tr>
        <th>&nbsp;</th>
        <td><input name="button" type="submit" class="btn_gray" id="button" value="确定" /></td>
      </tr>
    </table>
    </form>
  </div>
