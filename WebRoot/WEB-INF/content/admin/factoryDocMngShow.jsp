...
<div class="main">
  ...
  <div class="right">
    ...
    <div class="btn_frame">
      ...
      <font color="red">说明：本页只列出你有权修改的图纸文档</font>
      </div>
    ...
    <form name="searchForm" action="factoryDocMngShow.do" method="post" onsubmit="schFormOnSubmit();">
    ...
    <table width="99%" border="0" cellpadding="0" cellspacing="0" class="table_list">
        ...
        <tr <s:if test="#stat.even==true">class="td_bg1"</s:if>>
         ...
         技术文件
          ...
          <td align="center">
          	<a href="<s:url action="viewTaskFactory" namespace="/admin"><s:param name="id" value="task.id"/></s:url>" class="font_green"><strong><u>发放</u></strong></a>
          </td>
        </tr>
        </s:iterator>
      </table>
      <p class="page-inner" style="text-align:right;width:99%">
		<pg:pager items="${totalCount}" url="${pageContext.request.contextPath}/admin/factoryDocMngShow.do" index="center" maxPageItems="10" maxIndexPages="10" isOffset="<%=false%>" export="currentPageNumber=pageNumber" scope="request">
		<pg:index export="pageCount">
			...
			转到  <select onchange="selectedPage=this.value;jumpPage('<s:url value="/admin/factoryDocMngShow.do"/>',selectedPage)">
