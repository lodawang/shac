...
<div class="main">
  ...
  <div class="right">
    ...
    <div class="btn_frame">
     ...
     <form action="saveadviceleveone.do" method="post" enctype="multipart/form-data">
        ...
        <table width="99%" border="0" cellpadding="0" cellspacing="0" class="table_form">
         ...
         工艺文档
          ...
          <tr>
            <th>反馈意见：</th>
	        <td><s:textarea name="advice.bakeone" cols="40" rows="10" ></s:textarea></td>
	        <td>&nbsp;</td>
	        <td>&nbsp;</td>
          </tr>
          <tr>
              <td>
              <input name="button" type="submit" class="btn_gray" id="button" value="提 交" />
              </td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
