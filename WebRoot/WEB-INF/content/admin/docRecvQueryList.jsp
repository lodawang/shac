...
<div class="main">
  ...
  <div class="right">
    ...
    <form name="searchForm" action="docRecvQueryList.do" method="post">
...
<tr>
        ...
        <tr <s:if test="#stat.even==true">class="td_bg1"</s:if>>
          ...
          <td> <s:property value="task.drawingNumb"/> &nbsp;</td>
      ...
      <p class="page-inner" style="text-align:right;width:99%">
		<pg:pager items="${totalCount}" url="${pageContext.request.contextPath}/admin/docRecvQueryList.do" index="center" maxPageItems="500" maxIndexPages="500" isOffset="<%=false%>" export="currentPageNumber=pageNumber" scope="request">
		<pg:index export="pageCount">
			...
			转到  <select onchange="selectedPage=this.value;jumpPage('<s:url value="/admin/docRecvQueryList.do"/>',selectedPage)">
